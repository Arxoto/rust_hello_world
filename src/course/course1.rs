...
/// 
/// ```
/// // 这是行代码注释，适用于单行，或者临时将代码注释 `CTRL+/`
/// /*
/// 这是块代码注释
/// vscode 中使用【很方便】 打出注释开头 - 回车 - 注释内容 - 最后再加个回车
///  */
/// ```
///
/// ## 文档注释
/// 
/// - 生成文档介绍包功能特性和使用方式（内部实现细节不应暴露）
/// - 支持 markdown 语法
/// - 还能用来跑单测 `cargo test` 里会写明 "Doc-tests"
/// - 代码跳转，如 [`Result`]
/// 
/// ```
/// /// 行文档注释
/// /// vscode 中，回车自动添加下一行注释的开头【很方便】
/// fn annotation_line(){}
///
/// /**
/// 块文档注释
/// vscode 中，回车会自动添加星号，与 markdown 语法冲突
/// 因此【不推荐】，如无必要一般都用行注释即可
///  */
/// fn annotation_block(){}
/// ```
/// 
